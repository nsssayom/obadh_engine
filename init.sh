...
verify_file "$AUTOSUGGEST_PATH/models/neural/autosuggest.manifest.json"
verify_file "$AUTOSUGGEST_PATH/models/neural/vocab.manifest.json"
verify_resolved_file "$AUTOSUGGEST_PATH/models/neural/autosuggest.onnx"
verify_resolved_file "$AUTOSUGGEST_PATH/models/neural/vocab.tsv"
