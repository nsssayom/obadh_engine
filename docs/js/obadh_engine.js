...
export class ObadhAutocorrectWasm {
    static __wrap(ptr) {
        const obj = Object.create(ObadhAutocorrectWasm.prototype);
        obj.__wbg_ptr = ptr;
        ObadhAutocorrectWasmFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ObadhAutocorrectWasmFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_obadhautocorrectwasm_free(ptr, 0);
    }
    /**
     * @param {Uint8Array} bytes
     * @returns {ObadhAutocorrectWasm}
     */
    static fromCompactLexicon(bytes) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_export);
            const len0 = WASM_VECTOR_LEN;
            wasm.obadhautocorrectwasm_fromCompactLexicon(retptr, ptr0, len0);
     ...
     * @returns {ObadhAutocorrectWasm}
     */
    static fromFstLexicon(bytes) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_export);
            const len0 = WASM_VECTOR_LEN;
            wasm.obadhautocorrectwasm_fromFstLexicon(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    /**
     * @param {Uint8Array} bytes
     * @param {Uint8Array} loanword_bytes
     * @returns {ObadhAutocorrectWasm}
     */
    static fromFstLexiconWithLoanwords(bytes, loanword_bytes) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_export);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passArray8ToWasm0(loanword_bytes, wasm.__wbindgen_export);
            const len1 = WASM_VECTOR_LEN;
            wasm.obadhautocorrectwasm_fromFstLexiconWithLoanwords(retptr, ptr0, len0, ptr1, len1);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
     ...
     * @returns {ObadhAutocorrectWasm}
     */
    static fromTsv(lexicon_tsv) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(lexicon_tsv, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            wasm.obadhautocorrectwasm_fromTsv(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    constructor() {
        const ret = wasm.obadhautocorrectwasm_new();
        this.__wbg_ptr = ret;
        ObadhAutocorrectWasmFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @returns {any}
    ...
    stats() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.obadhautocorrectwasm_stats(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    /**
     * @param {string} roman_input
     * @returns {any}
     */
    suggest(roman_input) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(roman_input, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            wasm.obadhautocorrectwasm_suggest(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
...
if (Symbol.dispose) ObadhAutocorrectWasm.prototype[Symbol.dispose] = ObadhAutocorrectWasm.prototype.free;

export class ObadhAutosuggestWasm {
    static __wrap(ptr) {
        const obj = Object.create(ObadhAutosuggestWasm.prototype);
        obj.__wbg_ptr = ptr;
        ObadhAutosuggestWasmFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ObadhAutosuggestWasmFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
     ...
     */
    static fromNgramArtifact(bytes) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_export);
            const len0 = WASM_VECTOR_LEN;
            wasm.obadhautosuggestwasm_fromNgramArtifact(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    stats() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.obadhautosuggestwasm_stats(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
     ...
     * @returns {any}
     */
    suggest(context_tokens_js, limit) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
if (Symbol.dispose) ObadhAutosuggestWasm.prototype[Symbol.dispose] = ObadhAutosuggestWasm.prototype.free;
...
export class ObadhaWasm {
    ...
    transliterate_lenient(text) {
        ...
        try {
            ...
            const ptr0 = passStringToWasm0(text, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            wasm.obadhawasm_transliterate_lenient(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred2_0 = r0;
            deferred2_1 = r1;
...
const ObadhAutocorrectWasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_obadhautocorrectwasm_free(ptr, 1));
const ObadhAutosuggestWasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_obadhautosuggestwasm_free(ptr, 1));
